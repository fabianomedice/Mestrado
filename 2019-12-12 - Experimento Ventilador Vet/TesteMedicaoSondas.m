...
hold off
title('Resistências')
ylabel('Resistência [cmH_2O/L/s]')
xlabel('Variação de Pressão [cmH_2O]')
legend('Resistência Total (Pressão Ventilador - 0)/(Vazão)','Resistência Tubo Y (Pressão Ventilador - Pressão TOT)/(Vazão)','Resistência TOT identificado anteriormente','Resistência TOT identificado (Pressão TOT - 0)/(Vazão)','location','best')
...
% % % plot(Ptest,Ptest./FtestTOT75n+Ptest./FtestTuboY,'g')
hold off
title('Vazão Estimada')
ylabel('Vazão [L/s]')
xlabel('Variação de Pressão [cmH_2O]')
legend('Vazão Total (Pressão Ventilador - 0)/(Vazão)','Vazão Tubo Y (Pressão Ventilador - Pressão TOT)/(Vazão)','Vazão TOT identificado anteriormente','Vazão TOT identificado (Pressão TOT - 0)/(Vazão)','location','best')
...
% % % plot(Ptest,Ptest./FtestTOT75n+Ptest./FtestTuboY,'g')
hold off
title('Pressão x Vazão Estimada')
xlabel('Vazão [L/s]')
ylabel('Variação de Pressão [cmH_2O]')
legend('Vazão Total (Pressão Ventilador - 0)/(Vazão)','Vazão Tubo Y (Pressão Ventilador - Pressão TOT)/(Vazão)','Vazão TOT identificado anteriormente','Vazão TOT identificado (Pressão TOT - 0)/(Vazão)','location','best')
