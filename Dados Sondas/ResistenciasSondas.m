...
R = Regressores\Y'
% % R = Regressores\abs(Y) %Método 1
% % R = polyfit(X,abs(Y),2) %Método 2
% % R = lsqnonneg(Regressores,abs(Y)) %Método 3
...
% % % % % % % % Pressao_Estimada = (R(1)*Vazao_Estimado.^2+R(2)*abs(Vazao_Estimado)).*sign(Vazao_Estimado);
...
Pressao_Estimada = (R(1)*Vazao_Estimado.^2+R(2)*abs(Vazao_Estimado)).*sign(Vazao_Estimado);
scatter(Vazao_Estimado ,Pressao_Estimada,'g')
legend('Dados de Pressao usados no MMQ', 'Pressao Estimada','Location','northwest')
hold off
...
% % % % % % % % % hold on
% % % % % % % % % Vazao_Estimado = min(Vazao):0.0001:max(Vazao);
% % % % % % % % % Pressao_Estimada = (R(1)*Vazao_Estimado.^2).*sign(Vazao_Estimado);
% % % % % % % % % plot(Vazao_Estimado ,Pressao_Estimada,'r')
% % % % % % % % % legend('Pressao', 'Pressao Estimada','Location','northwest')
% % % % % % % % % hold off
